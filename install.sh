...
print_header_banner() {
    ...
    print_centered "${C_CYAN}│${C_WHITE}   _   _    _    _   _ ____ _____  _    _     _  __             ${C_CYAN}│${C_RESET}"
    print_centered "${C_CYAN}│${C_WHITE}  | | | |  / \  | \ | |  _ \_   _|/ \  | |   | |/ /             ${C_CYAN}│${C_RESET}"
    print_centered "${C_CYAN}│${C_WHITE}  | |_| | / _ \ |  \| | | | || | / _ \ | |   | ' /              ${C_CYAN}│${C_RESET}"
    print_centered "${C_CYAN}│${C_WHITE}  |  _  |/ ___ \| |\  | |_| || |/ ___ \| |___| . \              ${C_CYAN}│${C_RESET}"
    print_centered "${C_CYAN}│${C_WHITE}  |_| |_/_/   \_\_| \_|____/ |_/_/   \_\_____|_|\_\             ${C_CYAN}│${C_RESET}"
    print_centered "${C_CYAN}│                                                                │${C_RESET}"
